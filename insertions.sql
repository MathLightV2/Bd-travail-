...
VALUES     (nextval('seq_cali_id'),'2020-11-24 10:10:53','2010-11-24 10:10:53',id_employe('Bousquet','Noé'),290.03,290.07,290.08,(SELECT id_profileur FROM profileur WHERE marque ='Solinst')),
        (nextval('seq_cali_id'),'2021-11-24 10:10:53','2021-11-24 10:10:53',id_employe('Bousquet','Noé'),301.03,302.07,304.08,(SELECT id_profileur FROM profileur WHERE marque ='Dektak' )),
        (nextval('seq_cali_id'),'2015-11-24 10:10:53','2015-11-24 10:10:53',id_employe('Webster','Patrick'),260.03,250.07,250.08,(SELECT id_profileur FROM profileur WHERE marque ='Dektak')),
        (nextval('seq_cali_id'),'2016-11-24 10:10:53','2016-11-24 10:10:53',id_employe('Webster','Patrick'),265.03,250.07,250.08,(SELECT id_profileur FROM profileur WHERE marque ='Dektak')),
        (nextval('seq_cali_id'),'2017-11-24 10:10:53','2017-11-24 10:11:53',id_employe('Webster','Patrick'),280.03,250.07,250.08,(SELECT id_profileur FROM profileur WHERE marque ='Normandin')),
        (nextval('seq_cali_id'),'2018-11-24 10:10:53','2018-11-24 10:08:53',id_employe('Webster','Patrick'),270.03,250.07,250.08,(SELECT id_profileur FROM profileur WHERE marque ='Normandin')),
